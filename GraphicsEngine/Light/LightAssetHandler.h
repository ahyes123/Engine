...
class LightAssetHandler
{
	...
	public:
		...
		static std::shared_ptr<SpotLight> CreateSpotLight(Vector3f aColor, float anIntensity, float aRange, float aAttenuation, float aInnerCone, float aOuterCone, Vector3f aDirection, Vector3f aPosition);
};
